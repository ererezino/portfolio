...
var ARTICLES = [
  { title: "Happy 4th Birthday!", date: "Jan 2026", topic: "Accrue", url: "https://adesuwa.substack.com/p/happy-4th-birthday", image: "https://substackcdn.com/image/fetch/f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe5750dcb-9f05-4d83-9918-b6fdbee62059_2076x1488.png", featured: true, excerpt: "Adesuwa reflects on Accrue turning 4 with gratitude.", author: "Adesuwa Omoruyi", external: true },
...
function renderArticles() {
  ...
  ARTICLES.forEach(function(article) {
    var externalAttrs = article.external ? ' target="_blank" rel="noopener noreferrer"' : '';
    var authorLine = article.author ? '<span class="article-card-author">by ' + article.author + '</span>' : '';

    if (article.image) {
      // Card with image - uniform design for all
      html += '<a href="' + article.url + '"' + externalAttrs + ' class="article-card-image-card" role="listitem">' +
        ...
        '<div class="article-card-content">' +
          ...
          '<div class="article-card-footer">' +
            '<span class="article-card-date">' + article.date + (article.author ? ' · ' + article.author : '') + '</span>' +
      ...
      html += '<a href="' + article.url + '"' + externalAttrs + ' class="article-card" role="listitem" data-tilt>' +
        '<div>' +
          '<div class="article-card-topic">' + article.topic + '</div>' +
          '<h3 class="article-card-title">' + article.title + '</h3>' +
        '</div>' +
